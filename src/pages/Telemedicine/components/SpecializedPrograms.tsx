...
const ProgramCard: React.FC<ServiceCardProps & { iconName?: string }> = ({ title, description, icon, iconName }) => {
  ...
  return (
    <div className="group bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-teal-200 relative overflow-hidden">
      ...
      <div className="text-xl font-bold text-gray-900 mb-3" dangerouslySetInnerHTML={{ __html: title }} />
    ...
    <section id="programs" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="text-3xl md:text-4xl font-bold text-gray-900 mb-4" dangerouslySetInnerHTML={{ __html: title || "Specialized Telemedicine Programs" }} />
          <div className="text-lg text-gray-600" dangerouslySetInnerHTML={{ __html: description || "Tailored healthcare solutions designed to meet specific medical needs with expertise and care." }} />
        </div>
